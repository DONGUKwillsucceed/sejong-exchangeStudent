...
route.post('/:country/:school', documentController.postData);         // 게시물 create
route.put('/:country/:school/:id', documentController.putData);       // 게시물 update
route.delete('/:country/:school/:id', documentController.removeData);  // 게시물 delete
