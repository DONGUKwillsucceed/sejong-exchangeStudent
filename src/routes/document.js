...
route.get('/:country/:school/:id', isAuth, documentController.getAdata);  // 해당 게시물 출력
route.get('/:country/:school', isAuth, documentController.getPostingList);      // 해당 학교 게시물들 출력
route.get('/:country', isAuth, documentController.getSchoolList);            // 여러 학교들 출력
